...
<html lang="en">
  ...
  <body ng-app="mysfitsApp">
    ...
    <div style="text-align: center">
      <img src="https://www.mythicalmysfits.com/images/aws_mythical_banner.png" width="800px" align="center">
    </div>
  ...
  <script>
    ...
    var mysfitsApiEndpoint = "http://${lb_address}"; // example: 'http://mythi-publi-abcd12345-01234567890123.elb.us-east-1.amazonaws.com'
